...
Private Sub Command1_Click()
    MsgBox "My Little window Spyer32" & vbCrLf & "    By Ben Jones.", vbInformation, "Exit"
    Unload Form1: End
...
Dim Wnd_ClassCaption As String
    ...
    Wnd = WindowFromPoint(M_Mouse.x, M_Mouse.y) ' Get the windows hangle
    ...
    Wnd_ClassCaption = Left(Wnd_ClassCaption, Wnd_Class) ' Trim of any rubbish
